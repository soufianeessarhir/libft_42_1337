...
ft_putchar_fd.c	ft_strmapi.c	ft_putstr_fd.c	ft_putendl_fd.c	ft_putnbr_fd.c\

BSOURCES =  ft_lstnew.c ft_lstlast.c ft_lstiter.c ft_lstdelone.c ft_lstadd_back.c  ft_lstadd_front.c  ft_lstclear.c ft_lstsize.c\
